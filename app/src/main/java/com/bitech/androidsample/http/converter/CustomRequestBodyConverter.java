package com.bitech.androidsample.http.converter;
...
public class CustomRequestBodyConverter<T> implements Converter<T, RequestBody> {
    ...
    public RequestBody convert(T value) throws IOException {
        ...
        if (value instanceof File) {
            return RequestBody.create(STREAM_TYPE, (File) value);
        } else {
            ...
            jsonWriter.close();
            return RequestBody.create(JSON_TYPE, buffer.readByteString());
        }
    }
}
